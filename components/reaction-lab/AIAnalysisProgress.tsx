...
import type { StageId, StageStatus } from "@/lib/reaction-simulator/types";

const STAGE_ORDER: Array<{ id: StageId; label: string }> = [
  { id: "local_scan", label: "Local Pre-Scan" },
  { id: "contextual", label: "Risk Engine" },
...
export function AIAnalysisProgress(p: { statuses: Partial<Record<StageId, StageStatus>>; running: boolean }) {
